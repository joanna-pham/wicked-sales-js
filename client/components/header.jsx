    ...
    return (
      <div className=" main header-container">
        <nav className="navbar navbar-dark sticky-top navbar-style">
          <div className="navbar-brand hvr-icon-spin cursor-pointer" onClick={() => this.props.setView('catalog', {})}>
            <img src="/images/favicon.png" className="pr-2 icon-style hvr-icon"></img>
            Gamers Unite
          </div>
          <span className="items-count pt-2 cursor-pointer" onClick={() => this.props.setView('cart', {})}>
